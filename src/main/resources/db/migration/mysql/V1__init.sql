...
create table ingredient (id bigint not null auto_increment, amount varchar(255), description varchar(255), recipe_id bigint, unit_of_measure_id bigint, primary key (id)) engine=InnoDB;
